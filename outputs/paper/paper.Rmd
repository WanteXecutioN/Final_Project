...
Attendance here is a categorical variable that assigning, "High","Medium", "Low" according to the 25%,50% and 75% of variable attendance. Likewise is applied for the 2020/2021 season, where the only difference is that, "Some" and "Very Few" is applied to teams playing with some fans and teams playing very few fans in the stadium.
